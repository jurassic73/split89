...
### Programming the controllers
  ...
  Default keyboard firmware to flash with QMK Toolbox (right click page and save as split89_default.hex (might have to remove .txt extension) ) - [split89_default.hex](https://raw.githubusercontent.com/jurassic73/split89/main/split89_default.hex)

  NOTE: 10/19/21 - it's been noted that the generated hex from QMK configurator is having issues(columns are shifted). I'm troubleshooting this and will update this page when fixed. It was good initially but something has changed and needs fixing.
