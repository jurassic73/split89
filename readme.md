...
# Bill of Materials  
  ...
  * (2) space bar keys - 2.25u / 2.75u - As noted above, beyond the standard keycaps, you'll need to either source 2.25u/2.75u space bars(which can be tough) or just use shift keys for your space bars (2.25u and 2.75u) in reverse orientation.  Most keycap sets don't come with 'extra' space bar caps so I like to use these blank shift keys for space bars. The face angle of these shift caps, installed in reverse orientation, is really agreeable for your thumb to land on. They look odd at first, but once you try them in this orientation, I feel you will not want to change them.
...
Sounds like a lot and it is but if you build this, you will be stoked at the result and your efforts put in to it won't be in vain... least it was not for me.  This is my daily driver now and I use it all day long at work and afterwards.  I've built this four times now.  Stoked with the results of each build.
